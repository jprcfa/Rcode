...
style$OPCM.DE <- as.numeric(style$OPCM.DE)
...
chart.RollingStyle(style.xts["2005::",16],style.xts[,1:4], method="constrained", width=18)
chart.RollingStyle(style.xts["2005::",5],style.xts[,1:4], method="constrained", width=18, cex.legend = .7, colorset=rainbow12equal, las=1)
